...
\textbf{Fail to Reject} & \begin{tabular}[c]{@{}c@{}}Correct (TN)\end{tabular} & \begin{tabular}[c]{@{}c@{}}Type II Error (FN / Power=1-$\beta$)\end{tabular} \\ \hline
...
\textbf{Interaction}: When the effect of one factor changes across levels of another (e.g., Scent helps Cute lines more than Direct lines).\\
